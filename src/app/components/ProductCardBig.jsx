            ...
            <div className="pt-6">
                <nav aria-label="Breadcrumb">
                    <ol role="list"
                        ...
                        <li className="text-sm">
                            <a href={product.thumbnailUrl} aria-current="page"
                ...
                <div
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <p className="text-3xl tracking-tight text-gray-900">{product.defaultDisplayedPriceFormatted}</p>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <p className="text-base text-gray-900">{product.seoDescription}</p>
                            </div>
                        </div>

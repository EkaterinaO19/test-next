...
function Cart() {
    ...
    const setEmail = (newEmail) => (dispatch) => {
        setTimeout(() => {
                    ...
                    {cart.length !== 0 && (
                        <>
                                    ...
                                    <div className={"flex justify-end mt-2 gap-2 sm:flex-start"}>
                                        ...
                                        {openPromoInput && (
                                            <div className={"flex gap-3 mt-3"} ref={promoInputRef}>
                                                <input
                                                    className={"w-100 h-8 border-2 border-gray-700 rounded-md text-sm"}
                                                    placeholder={"Введите код купона"} type={"text"}/>
                                                <button
                                                    className={"font-bold cursor-pointer text-sm text-gray-700"}>Применить
                                                </button>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <form onSubmit={handleSubmit} className={"gap-3 mt-10"}>
                                <h1 className={"font-bold text-3xl text-center mb-3 sm:text-lg"}>Оформление
                                    заказа</h1>
